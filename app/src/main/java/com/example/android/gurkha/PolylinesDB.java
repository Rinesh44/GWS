...
public class PolylinesDB extends SQLiteOpenHelper {

    /**
     * Database name
     */
    private static String DBNAME = "gurkha";
     ...
     */
    private static final String DATABASE_TABLE = "polylines";
     ...
     * Constructor
     */
    public PolylinesDB(Context context) {
