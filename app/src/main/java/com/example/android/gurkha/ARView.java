...
import com.example.android.gurkha.utils.Compatibility;
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        try {
            ...
            try {
                ...
                supportedSizes = com.example.android.gurkha.utils.Compatibility.getSupportedPreviewSizes(parameters);
