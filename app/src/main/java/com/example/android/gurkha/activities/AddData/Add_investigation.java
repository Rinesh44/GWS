...
public class Add_investigation extends AppCompatActivity implements ResponseListener {
    public static EditText person, investigator, paymentbase, date, description;
    private static final String url = "http://gws.pagodalabs.com.np/investigate/api/investigate?api_token=";
    Button btn;
...
//                    OkHttpClient client = new OkHttpClient();
                ...
                mJobManager.addJobInBackground(new PostJob(url, parameter.toString(), Add_investigation.this));
/*
