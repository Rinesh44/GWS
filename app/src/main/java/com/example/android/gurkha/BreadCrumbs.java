...
public class BreadCrumbs extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bread_crumbs);
        ...
        btnFindPath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (InternetConnection.checkConnection(getApplicationContext())) {
                    ...
                    Toast.makeText(BreadCrumbs.this, "Unable to load data. No internet connection", Toast.LENGTH_SHORT).show();
            }
        });
    }
