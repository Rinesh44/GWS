...
public class Add_awc extends AppCompatActivity implements ResponseListener {
    EditText name, armyno, address, grant, cost, supervisor, remarks;
    Button button;
    private static final String url = "http://gws.pagodalabs.com.np/awc/api/awc?api_token=";
...
//                    OkHttpClient client = new OkHttpClient();
                    ...
                    mJobManager.addJobInBackground(new PostJob(url, parameter.toString(), Add_awc.this));
