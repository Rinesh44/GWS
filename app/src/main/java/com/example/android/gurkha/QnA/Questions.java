...
public class Questions extends AppCompatActivity {
    ...
    private static final String url = "http://pagodalabs.com.np/gws/form_poll/api/form?api_token=";
...
//                    Log.e("identity", id);
   ...
   /* void run() throws IOException {
    ...
    void getDetails() throws IOException {
        ...
        call = retrofit.create(ApiInterface.class).getResponse("gws/form_poll/api/form?api_token=" + token);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        String qName = innerObject.getString("column_label");
